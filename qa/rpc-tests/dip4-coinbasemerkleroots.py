...
from test_framework.test_framework import HawkkitTestFramework
...
class LLMQCoinbaseCommitmentsTest(HawkkitTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as HawkkitTestFramework doesn't support this atm)
