...
This document provides guidelines for internationalization of the Hawkkit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hawkkit_en.ts` remains unchanged.
