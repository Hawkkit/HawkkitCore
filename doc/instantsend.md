...
This mechanism has been integrated into Bitcore-Node-Hawkkit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hawkkitpay/insight-api-hawkkit#web-socket-api](https://github.com/hawkkitpay/insight-api-hawkkit#web-socket-api)
* API: [https://github.com/hawkkitpay/insight-api-hawkkit#instantsend-transactions](https://github.com/hawkkitpay/insight-api-hawkkit#instantsend-transactions)
