...
Arguments:
    <base_directory> - The base directory of a Hawkkit Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Hawkkit Core developers'
...
Arguments:
    <base_directory> - The base directory of Hawkkit Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Hawkkit Core repository.
"""
