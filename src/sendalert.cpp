...
2. run hawkkitd with -printalert or -sendalert like this:
   /path/to/hawkkitd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.hawkkit.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Hawkkit Core:0.12.0.58/"));
