 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1572019210, nBits=1e0ffff0, nNonce=377964, vtx=1)
...
{
    const char* pszTimestamp = "Today at 17 December 2019 Hawkkit was born to the world, Hello World!";
    const CScript genesisOutputScript = CScript() << ParseHex("04e6782872bfda6021943cbc7b0bcd83c6b8a296b7df5610c5201b4c5bb674630b8f88b0f63c4c60e80d18cd77c3ba0f63dfabcbb17b55c77df71a1c9d3fff57ac") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 999030; 
        ...
        consensus.defaultAssumeValid = uint256S("0x00000a01df6e4313d7c3f31d504a60943f56f88f1952089fdf883e9f05d65d0c"); 
        ...
        vAlertPubKey = ParseHex("04859e6896296d240d4d5369b623cb965f9131386d8e4dc100ad1e353083ec060211436a9c820c8520e80c363bbc4d9c430cc85d9744cdbfbc089371c8ae2903b0");
        nDefaultPort = 13636;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1576593692, 486624311, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000a01df6e4313d7c3f31d504a60943f56f88f1952089fdf883e9f05d65d0c"));
        assert(genesis.hashMerkleRoot == uint256S("0xb7726981fd3e767f1a72d119f62cac68521cb793c3a41cf1dfe1fd4e661ae03d"));


        vSeeds.push_back(CDNSSeedData("hawkkit.com", "node1.hawkkit.com"));
        vSeeds.push_back(CDNSSeedData("n2.hawkkit.com", "node2.hawkkit.com"));
        ...
        // Hawkkit BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Hawkkit BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Hawkkit BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"HGanN3W7Le4zP8bUEeEouYhuEMqJwLpa3w"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x0x00000a01df6e4313d7c3f31d504a60943f56f88f1952089fdf883e9f05d65d0c"))
        };

        chainTxData = ChainTxData{
            1576593692, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000087606b0acc64133b2fe9a25bf9b331d1471d60d59cf25fc15a520925945"); 

        pchMessageStart[0] = 0xf9;
        pchMessageStart[1] = 0xd1;
        pchMessageStart[2] = 0x95;
        pchMessageStart[3] = 0x7b;
        vAlertPubKey = ParseHex("04bb5f758ec4199c9ec15b2ac4b65a4ac9829bfc89b6f126c56be8decbf8bb0964e5c2da5499be65583774211932181e03cf1e7bff135c0b2f93a6c717e03fe83c");
        nDefaultPort = 23636;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1576595365UL, 487451764UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000087606b0acc64133b2fe9a25bf9b331d1471d60d59cf25fc15a520925945"));
        assert(genesis.hashMerkleRoot == uint256S("0xb7726981fd3e767f1a72d119f62cac68521cb793c3a41cf1dfe1fd4e661ae03d"));
        ...
        // Testnet Hawkkit BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Hawkkit BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Hawkkit BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"JebNrDsRUBQrbqgnccnoTEPhuhooeVaPf4"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x0000087606b0acc64133b2fe9a25bf9b331d1471d60d59cf25fc15a520925945"))
        };

        chainTxData = ChainTxData{
            1576595365, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1572019220, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x67c56d9b80e0f02278dd53522ff6b73ec016b41716c3ab4b3323c7249d7b5e5d"));
        assert(genesis.hashMerkleRoot == uint256S("0xfa869a8ab2670d8cdb49c41589ed960048882ceda8dc2a5ea56dfb66864ac2b2"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("hawkkitevo.org",  "devnet-seed.hawkkitevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x67c56d9b80e0f02278dd53522ff6b73ec016b41716c3ab4b3323c7249d7b5e5d"))
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1576595685, 486604799, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // calculate regression genesis block
        //consensus.hashGenesisBlock = uint256S("0x00");
        if (true && (genesis.GetHash() != consensus.hashGenesisBlock)) {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0d513463f03643a7bf4b2a1935ad2522a824269d042ff3c38411cadd294becd5"));
        assert(genesis.hashMerkleRoot == uint256S("0xb7726981fd3e767f1a72d119f62cac68521cb793c3a41cf1dfe1fd4e661ae03d"));
        ...
        // privKey: 6jceSy2zG1svBked1FYqsxphbQqtr45fZtWvTjT9pDwKV92D2Kw
        vSporkAddresses = {"JU2GZCeiwg3XRYVxU5oLTKMMgTBa4pJLBS"};
        nMinSporkKeys = 1;
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x0d513463f03643a7bf4b2a1935ad2522a824269d042ff3c38411cadd294becd5"))
        };
        ...
        // Regtest Hawkkit addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,43);
        // Regtest Hawkkit script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,44);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,171);
        // Regtest Hawkkit BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Hawkkit BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Hawkkit BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
