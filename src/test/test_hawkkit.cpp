...
#define BOOST_TEST_MODULE Hawkkit Test Suite

#include "test_hawkkit.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_hawkkit_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
