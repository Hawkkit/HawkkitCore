...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Hawkkit address\n"
            "  payee          - Print the masternode payout Hawkkit address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Hawkkit address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "hawkkit",               "masternode",             &masternode,             true,  {} },
    { "hawkkit",               "masternodelist",         &masternodelist,         true,  {} },
    { "hawkkit",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "hawkkit",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
